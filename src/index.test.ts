...
describe('aqicalc', function() {
    ...
    let testTable = {
        ...
        'PM2_5': {
            µgm3: [31, 61, 91, 121, 252, 500],
            expectedAQI: [52, 103, 203, 301, 401, 500]
        },
        'NO2': {
        ...
        'O3': {
            µgm3: [51, 101, 169, 211, 750, 1000],
            expectedAQI: [51, 101, 203, 301, 401, 500]
        },
        'CO': {
            µgm3: [1010, 2100, 10100, 17100, 34100, 49000],
            expectedAQI: [51, 101, 201, 301, 401, 500]
        },
        'SO2': {
            µgm3: [41, 82, 385, 810, 1610, 2620],
            expectedAQI: [51, 101, 201, 301, 401, 500]
        },
        'CO2': {
