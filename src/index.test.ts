...
describe('aqicalc', function() {
    ...
    it('should be aqi=350, primary=PM10 when 0, 0, 460, 0, 0, 0', () => {
        ...
        expect(AQICalc(data, 'CN')).toEqual([{ aqi: 350, pollutant: "PM10" }]);
    });
    ...
    it('should be aqi=250, primary=TVOC when 125, 10, 10, 10, 10, 10, 10', () => {
        let data = { TVOC: 124, SO2: 10, NO2: 10, PM10: 10, CO: 1, O3: 10, PM2_5: 10 };
        expect(AQICalc(data, 'CN')).toEqual([{ aqi: 50, pollutant: "TVOC" }]);
    });
 ...
 */
 describe('aqicalc', function() {
     ...
     it('should be aqi=250, primary=TVOC when 125, 10, 10, 10, 10, 10, 10', () => {
         let data = { TVOC: 124, SO2: 10, NO2: 10, PM10: 10, CO: 1, O3: 10, PM2_5: 10 };
         expect(AQICalc(data, 'US')).toEqual([{ aqi: 50, pollutant: "TVOC" }]);
     });
     it('should be aqi=500, primary=TVOC when 10000, 10, 10, 10, 10, 10, 10', () => {
         let data = { TVOC: 10000, SO2: 10, NO2: 10, PM10: 10, CO: 10, O3: 10, PM2_5: 10 };
         expect(AQICalc(data, 'US')).toEqual([{ aqi: 500, pollutant: "TVOC" }]);
     });
 });
